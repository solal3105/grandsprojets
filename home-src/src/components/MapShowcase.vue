...
const spaces = [
  {
    ...
    src: `${base}/ville/metropole-lyon/carte`,
    urlDisplay: 'openprojets.com/ville/metropole-lyon/carte',
    color: '#5AAB7D',
  },
  {
    id: 'projet',
    ...
    src: `${base}/ville/engages-projet/carte`,
    urlDisplay: 'openprojets.com/ville/engages-projet/carte',
    color: '#4E2BFF',
  },
  {
    id: 'besancon',
    name: 'Besançon',
    type: 'Ville - Espace démonstration',
    src: `${base}/ville/besancon/carte`,
    urlDisplay: 'openprojets.com/ville/besancon/carte',
    color: '#F2B327',
  },
]
