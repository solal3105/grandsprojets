...
Dans CityAll, votre commune est un canal parmi les villages adhérents dans une app mutualisée. Il n'y a pas de carte des chantiers, pas de fiche projet structurée, pas de suivi d'avancement.

---

## Open Projets : la carte des projets que CityAll ne propose pas

| Ce que vous voulez faire | Open Projets | CityAll (Lumiplan) |
|---|---|---|
| Carte géographique des chantiers | ✅ Natif | ❌ |
| Fiche projet (photos, statut, dates) | ✅ Natif | ❌ |
| Suivi d'avancement des travaux | ✅ Planifié → en cours → terminé | ❌ |
| Info visible toute la durée du chantier | ✅ Persistante | ❌ Flux d'actualités |
...
## Vous êtes déjà client Lumiplan ?

Vos panneaux LED, bornes et app Lumiplan restent en place. Open Projets s'ajoute comme couche cartographique web des projets, accessible depuis un lien ou un QR code. Les deux coexistent sans conflit.
